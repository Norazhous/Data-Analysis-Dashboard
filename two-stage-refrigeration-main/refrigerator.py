...
p[1]=CP.PropsSI('P', 'T', T[1], 'Q', 1, working_fluid[0]) #pressure(R134a,T=T[1],x=1)  # The first parameter is the one that we looking for, then after that, other parameters listed and the value is followed behind them.finally, the working fluid is added.
